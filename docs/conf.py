# -*- coding: utf-8 -*-
#
# wagtail-2fa documentation build configuration file, created by
...
htmlhelp_basename = 'wagtail_2fa-doc'
...
man_pages = [
    (master_doc, 'wagtail_2fa', u'wagtail-2fa Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wagtail_2fa', u'wagtail-2fa Documentation',
     author, 'wagtail_2fa', 'One line description of project.',
     'Miscellaneous'),
]
